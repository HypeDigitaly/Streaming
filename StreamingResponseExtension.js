export const StreamingResponseExtension = {
  ...
  render: async ({ trace, element }) => {
    ...
    // Main models registry — all entries route through OpenRouter
    const modelsRegistry = [
      ...
      // Llama / DeepSeek models (via OpenRouter)
      {
        id: 8,
      ...
      // Llama 4 Maverick / DeepSeek R1 (via OpenRouter)
      {
        id: 11,
        name: "meta-llama/llama-4-maverick",
        type: "openrouter",
